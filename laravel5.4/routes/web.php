...
//无抵押贷款
Route::get('/zero','\App\Http\Controllers\Home\ZeroController@index');
Route::get('/please','\App\Http\Controllers\Home\ZeroController@please');
Route::post('/add2','\App\Http\Controllers\Home\ZeroController@add2');
Route::post('/img_add','\App\Http\Controllers\Home\ZeroController@img_add');
Route::post('/img_add2','\App\Http\Controllers\Home\ZeroController@img_add2');
/*
 * 我要借款
 * 首页
 */
...
Route::group(['prefix' => 'admin'], function() {
            ...
            Route::any('/adminzero/show','\App\Http\Controllers\Admin\AdminZeroController@show');
