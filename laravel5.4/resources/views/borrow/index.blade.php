                        ...
                        <div class="bor_det_one clearfix pt30 pb30">
                            ...
                            <div class="bor_det_oner fl">
                                <form method="post" action="/borrow_add">
                                    ...
                                    <div class="mt15">
                                        <label>*身份证号</label>
                                        <input id="cid_card" name="id_card" type="text" maxlength="18" onkeyup="value=value.replace(/^[a-zA-Z]+\D*|^\d{0,16}[a-zA-Z]+|[^0-9Xx]/g,'') " onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" />
