...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="/adminuser"><span class="icon-caret-right"></span>用户审核</a></li>

  </ul>   
  <h2><span class="icon-pencil-square-o"></span>栏目管理</h2>
  <ul>
    <li><a href="adminlist"><span class="icon-caret-right"></span>内容管理</a></li>
    <li><a href="adminadd"><span class="icon-caret-right"></span>添加内容</a></li>
