    ...
    <form method="post" class="form-x" action="/admin/adminadd_do"> 
     ...
     <input type="hidden" name="_token" value="{{csrf_token()}}">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <select class="input tips" style="width:25%; float:left;" name="status">
          <?php foreach ($list as $key => $v) {?>
            <option value="<?php echo $v->cate_id?>"><?php echo $v->cate;?></option>
          <?php }?>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" id="url1" name="inter" placeholder="百分比" class="input tips" style="width:25%; float:left;"  value=""  data-toggle="hover" data-place="right" data-image="" />
          <div class="tips"></div>
        </div>
      </div>
