  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="/admin/admingoodsadd"> 添加内容</a> </li>
        <li>搜索：</li>
        <li>首页
    ...
    <table class="table table-hover text-center">
      ...
      <?php foreach ($list as $key => $v) { ?>
        <tr>
          ...
          <td><?php echo $v->min_money;?></td>
      
          <td><?php echo $v->g_name;?></td>
          <td><font color="#00CC99"><?php echo $v->month;?></font></td>
          <td><?php echo $v->inter;?></td>
          <td><?php echo $v->note;?></td>
          <td><?php echo $v->earnings;?></td>
          
          <td><div class="button-group"> <a class="button border-main" href="goodsupda?id=<?php echo $v->id;?>"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="admindelete?id=<?php echo $v->id;?>" onclick="return del(1,1,1)"><span class="icon-trash-o"></span> 删除</a> </div></td>
        </tr>
        <?php }?>
